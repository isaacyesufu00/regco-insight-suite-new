...
const sections = [
  ...
  { id: "law", label: "8. Governing Law", title: "8. Governing Law", body: <P>These terms are governed by Nigerian law. Disputes shall be resolved in Nigerian courts.</P> },
  { id: "contact", label: "9. Contact", title: "9. Contact", body: <P><a href="mailto:legal@regco.com.ng" style={{ color: "#0A0A0A", fontWeight: 600 }}>legal@regco.com.ng</a> — RegCo Technologies Limited, Abuja, FCT, Nigeria.</P> },
];
